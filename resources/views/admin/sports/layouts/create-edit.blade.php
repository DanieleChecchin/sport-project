    ...
    <div class="row">
        <div class="col-12">
            <form action="@yield("form-action")" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    <label for="player-last_name" class="form-label">player last_name:</label>
                    <input type="text" name="last_name" id="player-last_name" class="form-control" value="{{ old("last_name", $player->last_name) }}">

                </div>
                <div class="mb-3">
                    <label for="player-date_of_birth" class="form-label">player date_of_birth:</label>
